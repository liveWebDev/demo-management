    ...
    <div class="home-banner">
        ...
        <div class="login-panel">
            ...
            <div class="form-container">
                <form class="form-primary loginpanel" method="post" action="{!! url('/forgot-password') !!}" id="frmResetPassword">
                    {!! csrf_field() !!}
                    ...
                    <div class="login-btns">
                        <a href="javascript:void(0);" class="btn-login loginbtn" id="btnResetPassword">
                            <div class="square-shape">
