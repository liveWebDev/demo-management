    ...
    <div class="home-banner">
        ...
        <div class="login-panel">
            ...
            <div class="form-container">
                <form class="form-primary signup-form" method="post" action="{!! url('/create-account') !!}" id="frmSignup">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Social insurance number" name="insurance_number" value="{!! old('insurance_number') !!}">
                        @if($errors->has('insurance_number')) <p class="help-block">{{ $errors->first('insurance_number') }}</p> @endif
                    </div>
                    <div class="form-group">
                        <div class="square-shape">
                            <div class="shape-content"></div>
                        </div>
                        <input type="text" class="form-control" placeholder="DVLA points" name="dvla_points" value="{!! old('dvla_points') !!}">
                        @if($errors->has('dvla_points')) <p class="help-block">{{ $errors->first('dvla_points') }}</p> @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Living in UK since" name="living" value="{!! old('living') !!}">
                        @if($errors->has('living')) <p class="help-block">{{ $errors->first('living') }}</p> @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Documents" name="document" value="{!! old('document') !!}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Payment" name="payment" value="{!! old('payment') !!}">
                        @if($errors->has('payment')) <p class="help-block">{{ $errors->first('payment') }}</p> @endif
                    </div>
                    <div class="clearfix"></div>
                    <div class="login-btns">
                        <a href="javascript:void(0);" class="btn-login signup-btn" id="btnSignup">
                            <div class="square-shape">
                        ...
                        <a href="{!! url('/login') !!}" class="btn-login loginbtn">
                            <div class="square-shape">
                                <div class="shape-content">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" class="svg-icon">
